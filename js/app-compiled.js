...
function App({
  ...
  const Dashboard = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `h-4 rounded-full transition-all ${pagamentos.percentual >= 100 ? 'bg-green-500' : pagamentos.percentual >= 50 ? 'bg-yellow-500' : 'bg-red-500'}`,
      style: {
      ...
      className: "space-y-2"
    }, pagamentos.items.slice(0, 5).map((item, idx) => /*#__PURE__*/React.createElement("div", {
      key: idx,
      ...
      className: `font-medium ${item.pago ? 'text-gray-500 line-through' : 'text-gray-800'}`
    }, item.nome)), /*#__PURE__*/React.createElement("span", {
      className: `font-bold ${item.pago ? 'text-green-600' : 'text-gray-800'}`
    }, "R$ ", item.valor.toFixed(2))))))), (() => {
      const [expandido, setExpandido] = React.useState(false);
      const mesesComDados = ['jan', 'fev', 'mar', 'abr', 'mai', 'jun', 'jul', 'ago', 'set', 'out', 'nov', 'dez'].filter(mes => calcularTotais(mes).total > 0);
      const totalGastoAnoAteAgora = ['jan', 'fev', 'mar', 'abr', 'mai', 'jun', 'jul', 'ago', 'set', 'out', 'nov', 'dez'].reduce((sum, mes) => sum + calcularTotais(mes).total, 0);
      const totalMetaAno = metas.jan + metas.fev + metas.mar + metas.abr + metas.mai + metas.jun + metas.jul + metas.ago + metas.set + metas.out + metas.nov + metas.dez;
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: `text-2xl transition-transform ${expandido ? 'rotate-180' : ''}`
      }, "\u25BC")), /*#__PURE__*/React.createElement("p", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: `flex items-center gap-4 p-3 rounded-lg cursor-pointer transition-all ${mesAtualBool ? 'bg-blue-50 border-2 border-blue-300' : 'hover:bg-gray-50'}`
        }, /*#__PURE__*/React.createElement("div", {
          ...
          className: `font-semibold ${semDados ? 'text-gray-400' : 'text-gray-800'}`
        }, "R$ ", gasto.toFixed(0))), /*#__PURE__*/React.createElement("div", {
          className: "flex-1"
        }, /*#__PURE__*/React.createElement("div", {
          className: "w-full bg-gray-200 rounded-full h-3"
        }, /*#__PURE__*/React.createElement("div", {
          className: `h-3 rounded-full transition-all ${semDados ? 'bg-gray-300' : dentroMeta ? 'bg-green-500' : 'bg-red-500'}`,
          style: {
            width: meta > 0 ? `${Math.min(gasto / meta * 100, 100)}%` : '0%'
          }
        }))), /*#__PURE__*/React.createElement("div", {
          className: "w-24 text-right"
        }, /*#__PURE__*/React.createElement("span", {
          className: `font-bold ${semDados ? 'text-gray-400' : dentroMeta ? 'text-green-600' : 'text-red-600'}`
        }, semDados ? '-' : `${percentual.toFixed(0)}%`)), /*#__PURE__*/React.createElement("div", {
      ...
      className: `p-6 rounded-xl text-center ${comparacao.aumentou ? 'bg-gradient-to-r from-red-500 to-red-600' : 'bg-gradient-to-r from-green-500 to-green-600'} text-white`
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: `text-xs ${comparacao.totaisAtual.cartoes > comparacao.totaisAnterior.cartoes ? 'text-red-600' : 'text-green-600'}`
      ...
      className: `text-xs ${comparacao.totaisAtual.fixos > comparacao.totaisAnterior.fixos ? 'text-red-600' : 'text-green-600'}`
      ...
      className: `text-xs ${comparacao.totaisAtual.variaveis > comparacao.totaisAnterior.variaveis ? 'text-red-600' : 'text-green-600'}`
  ...
  const TelaPlanejamento = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `bg-gradient-to-r ${scoreInfo.bg} rounded-xl shadow-lg p-4 text-white`
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex justify-between items-center"
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, scoreSaude.criterios.map((c, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      className: "flex justify-between text-sm"
    }, /*#__PURE__*/React.createElement("span", null, c.nome), /*#__PURE__*/React.createElement("span", {
      className: "font-bold"
    }, c.pontos, " pts")))))), /*#__PURE__*/React.createElement("div", {
      className: "grid grid-cols-1 md:grid-cols-3 gap-4"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bg-white rounded-xl shadow-lg p-6"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: `text-xl font-bold mb-2 ${saldo.positivo ? 'text-green-600' : 'text-red-600'}`
      ...
      className: `text-xl font-bold mb-2 ${totais.total / saldo.receitas * 100 <= 70 ? 'text-green-600' : totais.total / saldo.receitas * 100 <= 90 ? 'text-yellow-600' : 'text-red-600'}`
      ...
      className: `text-xl font-bold mb-2 ${scoreSaude.percentualPoupanca >= 20 ? 'text-green-600' : scoreSaude.percentualPoupanca >= 10 ? 'text-yellow-600' : 'text-red-600'}`
      ...
      className: `h-6 rounded-full transition-all ${scoreSaude.percentualReserva >= 100 ? 'bg-green-500' : scoreSaude.percentualReserva >= 50 ? 'bg-blue-500' : scoreSaude.percentualReserva >= 16 ? 'bg-yellow-500' : 'bg-red-500'}`,
      style: {
        width: `${Math.min(scoreSaude.percentualReserva, 100)}%`
      }
      ...
      className: "text-xl font-bold"
    }, metasFinanceiras.filter(m => !m.concluida).length)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "text-sm opacity-75"
      ...
      className: "space-y-4"
    }, metasFinanceiras.filter(m => !m.concluida && m.dataMeta).sort((a, b) => new Date(a.dataMeta) - new Date(b.dataMeta)).slice(0, 5).map(meta => {
      const progresso = meta.valorAtual / meta.valor * 100;
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        month: 'long',
        year: 'numeric'
      }), diasRestantes > 0 && ` • ${diasRestantes} dias restantes`)), /*#__PURE__*/React.createElement("span", {
      ...
      className: "font-semibold"
    }, "Faltam:"), " ", 100 - scoreSaude.score, " pontos"))))), metasFinanceiras.filter(m => !m.concluida && m.dataMeta).length === 0 && dividas.length === 0 && scoreSaude.percentualReserva >= 100 && scoreSaude.score >= 100 && /*#__PURE__*/React.createElement("div", {
      className: "text-center py-12"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xl mb-4"
    }, "\uD83C\uDF89"), /*#__PURE__*/React.createElement("h4", {
    ...
    }, saldo.positivo ? `+R$ ${(saldo.saldo * 12).toFixed(0)} acumulado` : 'Sem acúmulo')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "text-sm opacity-75"
      ...
      className: "text-sm opacity-90 mt-1"
    }, saldo.positivo ? `+R$ ${(saldo.saldo * 36).toFixed(0)} acumulado` : 'Sem acúmulo')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "text-sm opacity-75"
      ...
      className: "text-sm opacity-90 mt-1"
    }, saldo.positivo ? `+R$ ${(saldo.saldo * 60).toFixed(0)} acumulado` : 'Sem acúmulo'))), /*#__PURE__*/React.createElement("div", {
