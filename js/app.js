      ...
      if (loading) {
        return (
          <div className="loading-screen">
            <img src={window.LOGO_B64} alt="Estratégia Finanças" style={{maxHeight:'80px', width:'auto', marginBottom:'1rem'}} />
      ...
      return (
        <div ref={ref} style={{position:'relative', flexShrink:0}}>
          ...
          >
            ...
            <span style={{fontSize:'0.85rem', fontWeight:'600', maxWidth:'120px', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>{nome}</span>
            <span style={{fontSize:'0.7rem', opacity:0.7}}>▾</span>
          </button>
          {aberto && (
            <div onClick={e => e.stopPropagation()} style={{
              position:'absolute', top:'calc(100% + 8px)', left:0, zIndex:9999,
              background:'#1e1b4b', borderRadius:'12px', minWidth:'220px',
              boxShadow:'0 12px 40px rgba(0,0,0,0.7)',
              border:'1px solid rgba(99,102,241,0.4)',
              overflow:'hidden'
            }}>
              <div style={{padding:'14px 16px', borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
                <div style={{fontWeight:'700', color:'#fff', fontSize:'0.9rem'}}>{nome}</div>
                <div style={{fontSize:'0.75rem', color:'rgba(255,255,255,0.5)', marginTop:'2px'}}>{email}</div>
              </div>
      ...
      return (
        <div className="min-h-screen" style={{ background: '#f0f2f8' }}>
          ...
          <div style={{
            ...
            <div style={{maxWidth:'1280px', margin:'0 auto', padding:'8px 16px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'12px'}}>
              ...
              <div style={{position:'absolute', left:'50%', transform:'translateX(-50%)'}}>
                <img src={window.LOGO_B64} alt="Estratégia Finanças" style={{maxHeight:'38px', width:'auto', objectFit:'contain'}} />
              </div>

              {/* DIREITA: Seletor de Ano */}
              <select 
                value={anoAtual} 
                ...
                style={{
                  ...
                  fontWeight:'600', cursor:'pointer', minWidth:'85px'
                }}
              >
                {[2024, 2025, 2026, 2027, 2028, 2029, 2030].map(ano => (
          ...
          {/* MENU DE NAVEGAÇÃO - dentro do header, sempre visível */}
          <div style={{
            background: 'linear-gradient(90deg, #1e1b4b 0%, #312e81 50%, #1e1b4b 100%)',
            borderBottom: '1px solid rgba(99,102,241,0.3)',
            position: 'sticky', top: '57px', zIndex: 45,
            overflow: 'visible'
          }}>
            <div style={{maxWidth:'1280px', margin:'0 auto', padding:'4px 16px', overflow:'visible', position:'relative'}}>
