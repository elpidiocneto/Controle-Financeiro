                ...
                return (
                    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
                        <div className="text-white text-center">
                            <div className="text-2xl font-bold mb-4">📝 Criando sua conta...</div>
                            <div className="text-lg">Aguarde alguns segundos</div>
                        </div>
                    </div>
                );
            }
                    ...
                    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 p-4">
                        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
                            <div className="flex justify-center mb-3">
                                <img 
                                    src="data:image/png;base64," 
                                    alt="Elpídio Finanças" 
                                    className="h-16"
                            ...
                            <div className="mt-3 text-center space-y-3">
                                {authMode === 'login' && (
                                    <div>
                                        <button
                                            onClick={async () => {
                                                const emailInput = prompt('📧 Digite seu email para reenviar a verificação:');
                                                if (emailInput) {
                                        ...
                                        >
                                            📧 Não recebeu o email de verificação? Clique aqui
                                        </button>
                                    </div>
                                )}
        ...
        function App({ user }) {
            ...
            const MenuNavegacao = React.memo(({ telaAtiva, setTelaAtiva, isUserAdmin }) => {
                ...
                const abrirSubmenu = (menu) => {
                    if (submenuTimeoutRef.current) {
                        clearTimeout(submenuTimeoutRef.current);
                    }
                    setSubmenuAberto(menu);
                };
                ...
                return (
                    <div className="menu-bar">
                        ...
                        <button 
                            ...
                            className={`menu-button ${telaAtiva === 'dashboard' ? 'active' : ''}`}
                        >
                            📊 Dashboard
                        </button>
                        ...
                        {isUserAdmin && (
                            <button 
                                ...
                                className={`menu-button ${telaAtiva === 'admin' ? 'active' : ''}`}
                            >
                                👑 Admin
                            </button>
                        )}
                        ...
                        <div className="menu-item">
                            <button 
                                ...
                                className={`menu-button ${telaAtiva.startsWith('planejamento') ? 'active' : ''}`}
                            >
                                📋 Planejamento <span style={{ fontSize: '0.6rem' }}>▼</span>
                            </button>
                            <div 
                                className={`submenu ${submenuAberto === 'planejamento' ? 'open' : ''}`}
                            >
                                <div onClick={() => { setTelaAtiva('planejamento'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento' ? 'active' : ''}`}>
                                    🏥 Diagnóstico
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-orcamento'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-orcamento' ? 'active' : ''}`}>
                                    📊 Orçamento
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-premes'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-premes' ? 'active' : ''}`}>
                                    📝 Pré-Mês
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-metas'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-metas' ? 'active' : ''}`}>
                                    🎯 Metas
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-dividas'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-dividas' ? 'active' : ''}`}>
                                    💳 Dívidas
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-compra'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-compra' ? 'active' : ''}`}>
                                    🛒 Simulador de Compra
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-simulador'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-simulador' ? 'active' : ''}`}>
                                    🎲 Simulador
                                </div>
                                <div onClick={() => { setTelaAtiva('planejamento-timeline'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'planejamento-timeline' ? 'active' : ''}`}>
                                    📈 Timeline
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Receitas */}
                        <button 
                            onClick={() => setTelaAtiva('receitas')}
                            className={`menu-button ${telaAtiva === 'receitas' ? 'active' : ''}`}
                        >
                            💰 Receitas
                        </button>
                        ...
                        <div className="menu-item">
                            <button 
                                ...
                                className={`menu-button ${['cartoes', 'fixos', 'variaveis', 'extras'].includes(telaAtiva) ? 'active' : ''}`}
                            >
                                💸 Despesas <span style={{ fontSize: '0.6rem' }}>▼</span>
                            </button>
                            <div 
                                className={`submenu ${submenuAberto === 'despesas' ? 'open' : ''}`}
                            >
                                <div onClick={() => { setTelaAtiva('cartoes'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'cartoes' ? 'active' : ''}`}>
                                    💳 Cartões
                                </div>
                                <div onClick={() => { setTelaAtiva('fixos'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'fixos' ? 'active' : ''}`}>
                                    🏠 Gastos Fixos
                                </div>
                                <div onClick={() => { setTelaAtiva('variaveis'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'variaveis' ? 'active' : ''}`}>
                                    📊 Gastos Variáveis
                                </div>
                                <div onClick={() => { setTelaAtiva('extras'); setSubmenuAberto(null); }} className={`submenu-item ${telaAtiva === 'extras' ? 'active' : ''}`}>
                                    ⚡ Gastos Extras
                                </div>
                            </div>
                        </div>
                        ...
                        <button 
                            ...
                            className={`menu-button ${telaAtiva === 'farol' ? 'active' : ''}`}
                        >
                            🚦 Farol
                        </button>
                    </div>
            ...
            const Dashboard = () => {
                ...
                return (
                    <div className="space-y-3">
                        {/* CARDS DE RESUMO UNIFICADOS - LINHA ÚNICA */}
                        <div className="grid grid-cols-2 md:grid-cols-7 gap-3">
                            {/* Pagamentos */}
                            <div style={{ background: 'white', border: '1px solid #E5E7EB' }} className="rounded-xl shadow-sm compact-card">
                                <div className="text-xs text-gray-500">✔️ PAGOS</div>
                                <div className="text-xl font-bold mt-1 text-gray-900">{pagamentos.percentual.toFixed(0)}%</div>
                                <div className="text-xs text-gray-500 mt-1">{pagamentos.qtdPago}/{pagamentos.qtdTotal}</div>
                            </div>

                            {/* Meta Mensal */}
                            {metaMensal > 0 ? (
                                <div style={{ background: 'white', border: '1px solid #E5E7EB' }} className="rounded-xl shadow-sm compact-card">
                                    <div className="text-xs text-gray-500">🎯 META {mesAtual.toUpperCase()}</div>
                                    <div className="text-xl font-bold mt-1 text-gray-900">{((totais.total / metaMensal) * 100).toFixed(0)}%</div>
                                    <div className="text-xs text-gray-500 mt-1">R$ {metaMensal.toFixed(0)}</div>
                                </div>
                            ) : (
                                <div style={{ background: 'white', border: '1px solid #E5E7EB' }} className="rounded-xl shadow-sm compact-card">
                                    <div className="text-xs text-gray-500">🎯 META</div>
                                    <div className="text-xl font-bold mt-1 text-gray-900">-</div>
                                    <div className="text-xs text-gray-500 mt-1">Não definida</div>
                                </div>
                            )}
            ...
            return (
                <div className="min-h-screen" style={{ background: '#F9FAFB' }}>
                    {/* Header */}
                    <div className="bg-white shadow-lg sticky-desktop top-0 z-20">
                        <div className="max-w-7xl mx-auto px-2 md:px-4 py-1 md:py-2">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-2">
                                {/* Seletor de ano - esquerda no desktop */}
                                <div className="order-2 md:order-1">
                                    <select 
                                        value={anoAtual} 
                                        onChange={(e) => setAnoAtual(parseInt(e.target.value))}
                                        className="px-3 py-1 rounded-lg text-sm font-semibold border-2 border-blue-500 bg-white text-gray-800 cursor-pointer hover:bg-blue-50"
                                ...
                                <div className="order-1 md:order-2 flex justify-center items-center">
                                    <img 
                                        src="data:image/png;base64," 
                                        alt="Elpídio Neto Finanças" 
                                        className="h-10 md:h-12"
                                        style={{ maxWidth: '250px', objectFit: 'contain' }}
                                    />
                                </div>
                                <div className="flex flex-col md:flex-row gap-1 items-center order-3">
                                    <div className="flex items-center gap-2 px-2 py-1 bg-blue-50 rounded-lg">
                                        ...
                                        {/* DEBUG: Mostrar status de admin */}
                                        <span className={`px-2 py-0.5 rounded text-xs font-bold ${isUserAdmin ? 'bg-purple-500 text-white' : 'bg-gray-300 text-gray-700'}`}>
                                        ...
                                        {!salvando && ultimoSave && (
                                            <span className="text-xs text-green-600" title={`Último save: ${ultimoSave.toLocaleTimeString()}`}>
                                                ✅
                                            </span>
                                        )}
                                    </div>
                                    <div className="flex gap-1 mobile-stack md:flex-row">
                                    <button 
                                        onClick={fazerBackup}
                                        className="px-2 md:px-4 py-1 md:py-2 bg-green-600 text-white rounded-lg text-xs md:text-sm font-semibold hover:bg-green-700"
                                    ...
                                    <button 
                                        ...
                                        className="px-2 md:px-4 py-1 md:py-2 bg-blue-600 text-white rounded-lg text-xs md:text-sm font-semibold hover:bg-blue-700"
                                    ...
                                    <button 
                                        onClick={() => {
                                            if (confirm('⚠️ ATENÇÃO: Isso vai APAGAR todos os dados salvos. Confirma?')) {
                                                localStorage.clear();
                                                window.location.reload();
                                            }
                                        }}
                                        className="px-2 md:px-4 py-1 md:py-2 bg-red-600 text-white rounded-lg text-xs md:text-sm font-semibold hover:bg-red-700"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className="px-2 md:px-4 py-1 md:py-2 bg-gray-700 text-white rounded-lg text-xs md:text-sm font-semibold hover:bg-gray-800"
                                        title="Sair da conta"
                                    >
                    ...
                    <div className="bg-white border-b shadow-sm sticky-desktop top-[60px] md:top-[70px] z-10">
                        <div className="max-w-7xl mx-auto px-2 md:px-4 py-2">
                            <div className="flex gap-1 md:gap-2 overflow-x-auto">
                                {MESES.map(mes => (
                                    <button key={mes} onClick={() => setMesAtual(mes)} className={`px-3 md:px-4 py-1 md:py-2 rounded-lg text-xs md:text-sm font-semibold whitespace-nowrap ${mesAtual === mes ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
                                        {mes.toUpperCase()}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg sticky-desktop top-[105px] md:top-[115px] z-10">
                    ...
                    {/* Content */}
                    <div className="max-w-7xl mx-auto px-2 md:px-4 py-4 md:py-8 main-content">
                        {React.useMemo(() => {
