            ...
            if (loading) {
                return (
                    <div className="loading-screen">
                        ...
                        <div className="loading-title">Elpídio Finanças</div>
                            ...
                            <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'12px'}}>
                                ...
                                <div style={{display:'flex', alignItems:'center', gap:'8px', flexShrink:0}}>
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{fontSize:'0.75rem', color:'rgba(255,255,255,0.7)', maxWidth:'120px', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>
                                            {user.displayName || user.email?.split('@')[0]}
                                        </span>
                                        {isUserAdmin && (
                                            <span style={{fontSize:'10px', background:'linear-gradient(135deg,#6366f1,#8b5cf6)', color:'#fff', padding:'1px 6px', borderRadius:'4px', fontWeight:'700'}}>
                                                ADMIN
                                            </span>
                                        )}
                                        {salvando && <span style={{fontSize:'12px'}}>⏳</span>}
                                        {!salvando && ultimoSave && <span style={{fontSize:'12px'}}>✅</span>}
                                    </div>
                                    <div style={{display:'flex', gap:'4px'}}>
                                    <button 
                                        onClick={fazerBackup}
                                        title="Baixar backup"
                                        style={{padding:'6px 10px', borderRadius:'8px', border:'none', cursor:'pointer', fontSize:'14px', background:'rgba(16,185,129,0.2)', color:'#10b981'}}
                                    >💾</button>
                                    <button 
                                        onClick={restaurarBackup}
                                        title="Restaurar backup"
                                        style={{padding:'6px 10px', borderRadius:'8px', border:'none', cursor:'pointer', fontSize:'14px', background:'rgba(99,102,241,0.2)', color:'#818cf8'}}
                                    >📥</button>
                                    <button 
                                        onClick={() => {
                                        ...
                                        title="Resetar dados"
                                        style={{padding:'6px 10px', borderRadius:'8px', border:'none', cursor:'pointer', fontSize:'14px', background:'rgba(239,68,68,0.2)', color:'#f87171'}}
                                    >🔄</button>
                                    <button 
                                        onClick={() => {
                                        ...
                                        title="Sair"
                                        style={{padding:'6px 10px', borderRadius:'8px', border:'none', cursor:'pointer', fontSize:'14px', background:'rgba(255,255,255,0.1)', color:'rgba(255,255,255,0.7)'}}
                                    >🚪</button>
                                </div>
                                </div>
                            </div>
